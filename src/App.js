    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick={()=> setHomeScore(homeScore + 7)} className="homeButtons_touchdown">Home Touchdown</button>
          <button onClick={()=> setHomeScore(homeScore + 3)} className="homeButtons_fieldgoal">Home Field Goal</button>
        </div>
